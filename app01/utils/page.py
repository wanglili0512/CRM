...
class Pagination(object):
    ...
    def page_html(self):
        ...
        if self.current_page_num <= 1:
            prev_page = '<li class="am-disabled"><a href="#">上一页</a></li>'
        else:
        ...
        for i in range(pager_start, pager_end):
            ...
            if i == self.current_page_num:
                temp = '<li class="am-active"><a href="?%s">%s</a></li>' %(self.params.urlencode(),i)
            else:
                temp = '<li><a href="?%s">%s</a></li>' % (self.params.urlencode(),i,)
            page_html_list.append(temp)

        if self.current_page_num >= self.all_pager:
            next_page = '<li class="am-disabled"><a href="#">下一页</a></li>'
        else:
